...
class HostOverrideArgs:
    def __init__(__self__, *,
                 ...
                 rr: pulumi.Input[_builtins.str],
                 mx: Optional[pulumi.Input[_builtins.str]] = None,
                 mx_prio: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def rr(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "rr")

    @rr.setter
    def rr(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "rr", value)

    @_builtins.property
    @pulumi.getter
    def mx(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "mx")

    @mx.setter
    def mx(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "mx", value)

    @_builtins.property
    @pulumi.getter
    def mx_prio(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "mx_prio")

    @mx_prio.setter
    def mx_prio(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("opnsense:unbound:HostOverride")
class HostOverride(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def mx(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "mx")

    @_builtins.property
    @pulumi.getter
    def mx_prio(self) -> pulumi.Output[Optional[_builtins.int]]:
        return pulumi.get(self, "mx_prio")
